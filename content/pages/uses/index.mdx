...
- Email: [**Protonmail.com**](https://protonmail.com/) is my first choice, though I also have a Gmail and Hotmail account.
- Password Manager: [**Bitwarden**](https://bitwarden.com/)
- Browser: [**Firefox Developer Edition**](https://www.mozilla.org/de/firefox/developer/) with my [**Borealis Theme**](https://github.com/eckertalex/borealis-firefox)
...
- Editor: [**Visual Studio Code**](https://code.visualstudio.com/insiders/) - See my [VSCode Configuration](./vscode)
