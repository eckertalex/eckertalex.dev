...
const components = {
  mail: (props: IconProps) => <Icon as={MailIcon} {...props} />,
  github: (props: IconProps) => <Icon as={GithubIcon} {...props} />,
  linkedin: (props: IconProps) => <Icon as={LinkedinIcon} {...props} />,
  twitter: (props: IconProps) => <Icon as={TwitterIcon} {...props} />,
  keybase: KeybaseIcon,
}
