...
tags: ['linux']
draft: false
summary: "I will describe in the following post how I configured my Laptop to dualboot Manjaro and Windows 10 Education"
---
...
<Image src="/static/img/manjaro-installation-with-win10-dualboot/root.png" height={742} width={791} alt="root" />
...
<Image src="/static/img/manjaro-installation-with-win10-dualboot/home.png" height={742} width={791} alt="home" />
...
<Image src="/static/img/manjaro-installation-with-win10-dualboot/swap.png" height={742} width={791} alt="swap" />

File size should be those remaining 2GB and file system is **linuxswap**.
Before we continue, we will have to do one more thing. We have to tell the system where to install **GRUB**, the linux bootloader. We will install GRUB on the same partition as the Windows Bootloader is installed. Generally, that is partition 2, or **/dev/sdb2**. It is known as the **EFI System Partition**.
Select partition 2 and hit **Edit**. All you need to do is specify the Mount Point as **/boot/efi**.

<Image src="/static/img/manjaro-installation-with-win10-dualboot/efi.png" height={632} width={478} alt="efi" />
...
<Image src="/static/img/manjaro-installation-with-win10-dualboot/users.png" height={701} width={1108} alt="users" />
...
Now, when you start your computer you should be able to select in the GRUB bootloader between Manjaro and Windows 10 and your dualboot system should be fully functional from this point!
