...
import {AnimatedAxis, AnimatedAreaSeries, XYChart, Tooltip, DataContext, lightTheme, darkTheme} from '@visx/xychart'
import {PatternLines} from '@visx/pattern'
import {useColorModeValue, useMediaQuery} from '@chakra-ui/react'
import {ChartData} from 'features/reading-list/util'
...
function Chart({readTotalMonth, readPerMonth}: ChartData) {
  ...
  return (
    <XYChart theme={theme} height={300} xScale={{type: 'band'}} yScale={{type: 'linear'}}>
      <ChartBackground />
      <AnimatedAreaSeries
      ...
      {isLargerThan768 ? <AnimatedAxis orientation="bottom" animationTrajectory="center" /> : null}
