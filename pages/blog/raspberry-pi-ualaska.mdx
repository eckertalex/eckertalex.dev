...
Since a few weeks, UAF offers an improved version of the UAlaska network. The process to set up a new connection was improved. With the new version all you have to do is type in your username and password. After digging around the internet I decided to give it a try. If it worked, it would also minimize the work in the future as it is unnecessary to download the needed root and user certificates.
