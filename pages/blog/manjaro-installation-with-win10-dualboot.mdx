...
![partitions1](/static/img/manjaro-installation-with-win10-dualboot/installer1.png)

Now you should be presented with the following screen:

![partitions2](/static/img/manjaro-installation-with-win10-dualboot/installer2.png)
...
![root](/static/img/manjaro-installation-with-win10-dualboot/root.png)
...
![home](/static/img/manjaro-installation-with-win10-dualboot/home.png)
...
![swap](/static/img/manjaro-installation-with-win10-dualboot/swap.png)
...
![efi](/static/img/manjaro-installation-with-win10-dualboot/efi.png)
...
![users](/static/img/manjaro-installation-with-win10-dualboot/users.png)
