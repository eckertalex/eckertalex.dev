...
date: 2018-08-03
summary: "How to create a AJAX Form in PHP with Google Recaptcha."
---
...
<body>
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js"
            ...
            crossorigin="anonymous"></script>
    <script async src="js/contact-form.min.js"></script>
</body>

</html>
```

**Note:** You will need to manually go to [Google Recaptcha]'s website and register your site with recaptcha and then paste your site key in line 96 of my sample code, where I wrote **YOUR_SITE_KEY**.

This is how the contact form will look like:

<Image src="/static/img/ajax-php-recaptcha-form/contact-form.png" height={375} width={1092} alt="Example contact form" />
...
Next we will need to write our AJAX code to work as a intermediate layer between our html site and our PHP code. Read the inline comments to see what each part of the code does.
...
<Image src="/static/img/ajax-php-recaptcha-form/email.png" height={442} width={967} alt="Resulting email" />
